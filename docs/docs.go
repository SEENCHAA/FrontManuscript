    ...
    "definitions": {
        ...
        "ds.Manuscript": {
            ...
            "properties": {
                ...
                "letters": {
                    "description": "ВАЖНО: json:\"letters\" (с маленькой), чтобы фронт увидел массив",
                    "type": "array",
                    "items": {
        ...
        "ds.ManuscriptLetter": {
            ...
            "properties": {
                "letter": {
                    "description": "ВАЖНО: json:\"letter\" чтобы получить название и картинку внутри корзины",
                    "allOf": [
                        {
                            "$ref": "#/definitions/ds.Letter"
                        }
        ...
        "ds.ManuscriptListItemResponse": {
            ...
            "properties": {
                ...
                "finished_at": {
                    "description": "Дата завершения (может быть null)",
                    "type": "string"
                },
                "id": {
                    "type": "integer"
